module kmodules.xyz/resource-metrics/cmd/resource-calculator
...
require (
	...
	kmodules.xyz/resource-metrics v0.0.0-00010101000000-000000000000
	kubedb.dev/apimachinery v0.20.1-0.20210905084326-2a901017f244
