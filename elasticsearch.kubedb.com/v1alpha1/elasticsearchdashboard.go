...
func init() {
	...
	}, ElasticsearchDashboard{}.ResourceCalculator())
}

type ElasticsearchDashboard struct{}

func (r ElasticsearchDashboard) ResourceCalculator() api.ResourceCalculator {
...
func (r ElasticsearchDashboard) roleReplicasFn(obj map[string]any) (api.ReplicaList, error) {
...
func (r ElasticsearchDashboard) modeFn(obj map[string]any) (string, error) {
	return ElasticsearchDashboardModeDefault, nil
}

func (r ElasticsearchDashboard) usesTLSFn(obj map[string]any) (bool, error) {
	_, found, err := unstructured.NestedFieldNoCopy(obj, "spec", "tls")
	return found, err
}

func (r ElasticsearchDashboard) roleResourceFn(fn func(rr core.ResourceRequirements) core.ResourceList) func(obj map[string]any) (map[api.PodRole]api.PodInfo, error) {
	return func(obj map[string]any) (map[api.PodRole]api.PodInfo, error) {
		...
		container, replicas, err := api.AppNodeResourcesV2(obj, fn, ElasticsearchDashboardContainerName, "spec")
		if err != nil {
			return nil, err
		}
