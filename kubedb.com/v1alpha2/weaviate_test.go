...
func TestWeaviate(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "testdata/kubedb.com/v1alpha2/weaviate/standalone.yaml",
			want: want{
				replicas: 1,
		...
		{
			name: "testdata/kubedb.com/v1alpha2/weaviate/cluster.yaml",
			want: want{
				replicas: 3,
				mode:     DBModeCluster,
				totalResources: core.ResourceRequirements{
