...
func init() {
	api.Register(schema.GroupVersionKind{
		...
		Version: "v1alpha2",
		Kind:    "Qdrant",
	}, Qdrant{}.ResourceCalculator())
}

type Qdrant struct{}

func (r Qdrant) ResourceCalculator() api.ResourceCalculator {
...
func (r Qdrant) roleReplicasFn(obj map[string]interface{}) (api.ReplicaList, error) {
...
func (r Qdrant) modeFn(obj map[string]interface{}) (string, error) {
