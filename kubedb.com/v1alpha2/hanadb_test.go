...
func TestHanaDB(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "testdata/kubedb.com/v1alpha2/hanadb/standalone.yaml",
			want: want{
				replicas: 1,
				...
				totalResources: core.ResourceRequirements{
					Limits: core.ResourceList{
						...
						core.ResourceStorage: resource.MustParse("64Gi"),
					},
			...
			want: want{
				...
				appResources: core.ResourceRequirements{
					...
					Requests: core.ResourceList{
						...
						core.ResourceMemory:  resource.MustParse("24Gi"),
						core.ResourceStorage: resource.MustParse("200Gi"),
					},
				},
			},
